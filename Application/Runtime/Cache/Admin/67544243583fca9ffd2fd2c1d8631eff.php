...
<div class="boxwrap">
    <div class="box">
        ...
        <div class="box-content">
            <p>你可以在这里更改网站中，文章栏目的设置，目前既支持一级栏目也支持耳机栏目。需要提醒的是，网站前端的结构已经成型，如果确实要更改，请先联系本站开发人员。如需删除，则在其下的所有二级栏目将会一并被删除</p>
            ...
            <table class="table">
                ...
                <?php if(is_array($cols)): $i = 0; $__LIST__ = $cols;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cols): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <span class="operate">
                            ...
                            <a href="/rrzh/index.php/Admin/System/delete/code/<?php echo ($cols['code']); ?>" class="btn btn-danger btn-xs upd-col" code="<?php echo ($cols['code']); ?>">删除</a>
                        </span>
                        </td>
...
<div class="boxwrap40">
    <div class="box">
        ...
        <div class="box-content">
            <form action="/rrzh/index.php/Admin/System/SaveColumn" method="post" id="form-column">
         <!--    <form action="/rrzh/index.php/Admin/System/SaveEdit" method="post" id="form-column">
          </if> -->
