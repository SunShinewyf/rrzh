           ...
           <form action="/rrzh/index.php/Admin/System/SaveEdit" method="post" id="form-column">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="cparent" name="cparent">
                        ...
                        <?php if(is_array($parcol)): $i = 0; $__LIST__ = $parcol;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$parcol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($parcol['code']); ?>" <?php if($parcol['code'] == $result['cparent']): ?>selected<?php endif; ?>><?php echo ($parcol['cname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
